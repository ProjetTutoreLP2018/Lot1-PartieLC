    ...
    public partial class LCBDContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            if (!optionsBuilder.IsConfigured)
            {
                ...
                optionsBuilder.UseSqlServer(@String.Format("Server={0};Database={1};Trusted_Connection=False;Encrypt=True;User={2};Password={3}",
                    lot1.Properties.Settings.Default.BDDNomHote,
                    lot1.Properties.Settings.Default.BDDNom,
                    lot1.Properties.Settings.Default.BDDNomUtilisateur,
                    lot1.Properties.Settings.Default.BDDMotDePasse));
            }
        }
